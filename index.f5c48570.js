...
var _splitText = require("./scripts/SplitText");
...
requestAnimationFrame(raf);
// HERO
const housingWordChars = new (0, _splitText.SplitText)(".hero-title__word--housing").chars;
const authorityWordChars = new (0, _splitText.SplitText)(".hero-title__word--authority").chars;
const managementWordChars = new (0, _splitText.SplitText)(".hero-title__word--management").chars;
const softwareWordChars = new (0, _splitText.SplitText)(".hero-title__word--software").chars;
...
// THE PROBLEM
const problemParagraph1chars = new (0, _splitText.SplitText)(".the-problem__paragraph--1").chars;
const problemParagraph2chars = new (0, _splitText.SplitText)(".the-problem__paragraph--2").chars;
gsap.set(problemParagraph1chars, {
    opacity: 0.05
});
gsap.set(problemParagraph2chars, {
    opacity: 0.05
});
gsap.timeline({
    scrollTrigger: {
...
const problemSolutionLinePath = document.querySelector(".problem-solution-line-path");
...
},{"./scripts/SplitText":"kuIGl"}],"kuIGl":[function(require,module,exports) {
...
class SplitText {
    ...
    constructor(selector){
        ...
        if (element) initialText.forEach((char)=>{
            ...
            span.innerHTML = char;
            if (char.trim()) span.style.display = "inline-block";
...
},{}]},["aJPIF","8ZNvh"], "8ZNvh", "parcelRequire16e7")
